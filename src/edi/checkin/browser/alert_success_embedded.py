...
<html>
  <head>
    ...
    <title>Alert - Something good happened</title>
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    ...
                    <br> Hast Du diese E-Mail ohne eigene Veranlassung erhalten? <a href="https://www.educorvi.de/contact-info">Kontakt</a>.
                  </td>
                </tr>
                <tr>
...
<!-- END CENTERED WHITE CONTAINER --></div>
    ...
    successbody = successbody.replace('edi__datum', data.get('date'))
